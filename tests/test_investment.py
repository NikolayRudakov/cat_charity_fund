...
def test_fully_invested_amount_for_two_projects(
    ...
    ), test_fully_invested_amount_for_two_projects.__doc__
    assert (
        not charity_project_nunchaku.fully_invested
    ), test_fully_invested_amount_for_two_projects.__doc__
    assert (
        charity_project_nunchaku.invested_amount == 0
    ), test_fully_invested_amount_for_two_projects.__doc__
...
def test_donation_to_little_invest_project(
    ...
    assert (
        not charity_project_little_invested.fully_invested
    ), test_donation_to_little_invest_project.__doc__
    assert (
